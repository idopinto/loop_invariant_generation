...
#         self.no_repair = args.no_repair

#         self.working_dir, self.code_dir = \
...
#         self.prompter = Prompter(self.program, args.model)
...
#                         all_hold = True
#                         # We need to verify a /\ b
#                         # Instead we verify (b -> a) and b
#                         for pred_id, predicate in enumerate(proof_goal):
#                             recursive_mode = (pred_id == 1 and len(proof_goal) == 2)
...
#                         else:
#                             # There is another way we could prove the assertion.
