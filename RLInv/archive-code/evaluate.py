...
class InvBenchEvaluatorConfig:
    ...
    tasks: List[Task]
    model: Model
    baseline_timing_file: str = "uautomizer25_evaluation_k3.json"
...
class InvBenchEvaluator:
    def __init__(self, config: InvBenchEvaluatorConfig):
        ...
        self.baseline = load_json(file_path=self.config.baseline_timing_file)
        self.evaluators = []
        self.baseline_timing_lookup = {r["file"]: r["timings"]["median"] for r in self.baseline}
